...
>
    ...
    <div className='flex flex-col justify-between ml-4'>
        ...
        text-teal-100 m-2 
        px-2 py-1 rounded-full uppercase text-sm'>New!</span>}
        {featured && <span 
        className='bg-gray-800 text-white px-2 py-1 
        rounded-full uppercase text-sm'>Featured</span>}
        </h3>
    ...
    {tags
          ? tags.map((tag) => (
              <span
                ...
                bg-teal-100 font-bold mr-4 mb-4
                p-2 rounded text-align:center lg:mb-0"
              >
                {tag}
              </span>
            ))
